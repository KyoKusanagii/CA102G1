...
<%
	Integer news_no = new Integer(request.getParameter("news_no"));
	NewsService newsSvc = new NewsService();
	NewsVO newsVO = newsSvc.findByPK(news_no);
...
<head>
    ...
    <link rel="stylesheet" href="<%=request.getContextPath()%>/css/wickedpicker.scss">
	...
	<div class="container">
		...
		<form method="post" action="<%=request.getContextPath()%>/BackEnd/news.do">
			<div class="form-group">
			    ...
			    <textarea name="news_title" class="form-control rounded-0">${newsVO.news_title}</textarea>
			...
			<div class="form-group">
			    ...
			    <textarea name="news_content" class="form-control" style="font-size:20px;" rows="20">${newsVO.news_content}</textarea>
			...
			<input type="button" class="btn btn_info" value="取消" onclick="location.href = 'news/News.jsp'">
			</div>
		</form>
