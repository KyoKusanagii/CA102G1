...
<body>
	...
	<div class="container" style="background-color:white; height:600px; overflow:auto">
	<br>
		<div class="text-right"><button class="btn btn-primary" onclick="location.href = 'newsBrowse.jsp'"  scroll="no">回上頁</button></div>
		<div>
			<h1 style="font-family:微軟正黑體; color:#f44336">${newsVO.news_title}</h1>
			<hr color="black">
			<h4 style="font-family:微軟正黑體">發表時間：<fmt:formatDate pattern="YYYY年MM月dd日  HH:mm" value="${newsVO.news_date}" /></h4><br>
		</div>
		<div style="font-size:32px; font-family:微軟正黑體">
			${newsVO.news_content}
		</div>
