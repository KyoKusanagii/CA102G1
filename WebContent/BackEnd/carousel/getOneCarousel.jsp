    ...
    <div class="operationArea" align="center" style="padding-top: 40px;overflow:auto;">
		...
		<div class="container">    
	        <div class="card col-6">
	            ...
	            <img class="card-img-top" src="data:image/png;base64,${carouselVO.byteString}"  alt="Card image cap">
	            <div class="card-body">
	                <h5 class="card-title"><%=carouselVO.getCarousel_title()%></h5>
	                <h3 class="card-text"><%=carouselVO.getCarousel_subTitle()%></h3>
	            </div>
	        </div>
    	</div>
