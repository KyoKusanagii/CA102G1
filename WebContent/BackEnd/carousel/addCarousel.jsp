                 ...
                 <div class="card-body">
                   <div class="col-lg-8 d-flex flex-column">
                      ...
                      <form class="form-inline" action="<%=request.getContextPath()%>/BackEnd/carousel/carousel.do" method=post enctype="multipart/form-data">   
                       <input type="hidden" name="Carousel_pic_restore" value="<%= (carouselVO==null)? "" : carouselVO.getByteString()%>">
                        <input type="file" name="Carousel_pic" accept="image/gif, image/jpeg, image/png" id="slide1">
                         <img class="card-img-top" src="data:image/png;base64,${carouselVO.byteString}" onError="this.src='<%=request.getContextPath() %>/FrontEnd/images/nopic.jpg';" alt="Card image cap" id="slide1preview">
