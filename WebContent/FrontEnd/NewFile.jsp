...
<div class="container">
	...
	onclick=window.open("https://www.facebook.com/dialog/oauth?client_id=221160448483712&redirect_uri=https://ca102g1.tk<%=request.getContextPath()%>/FrontEnd/webSocketTest.jsp&scope=email&response_type=token")>
