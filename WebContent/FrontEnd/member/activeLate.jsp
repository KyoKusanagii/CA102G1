...
<!-- header -->
	...
	<div class="login-page">
		<div class="container"> 
			<h3 class="w3ls-title w3ls-title1" style="font-family:微軟正黑體; color:white">信箱驗證逾時</h3>  
			<div class="login-body" style="font-family:微軟正黑體; text-align:left">
				<h4><b>親愛的會員你好！</b></h4><br>
				<h4><b>InstaBuy辨識驗證連結已過有效時限！</b></h4><br>
				<h4><b>系統已重新寄送驗證連結</b></h4><br>
				<h4><b>此驗證連結將在30秒後失效</b></h4><br>
