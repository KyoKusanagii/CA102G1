...
<!-- header -->
	...
	<div class="login-page">
		<div class="container"> 
			<h3 class="w3ls-title w3ls-title1" style="font-family:微軟正黑體; color:white">已成功註冊InstaBuy帳號</h3>  
			<div class="login-body" style="font-family:微軟正黑體; text-align:left">
				<h4><b>親愛的會員你好！</b></h4><br>
				<h4><b>歡迎加入InstaBuy大平台！</b></h4><br>
				<h4><b>請立即前往信箱收取</b><b style="color:red">密碼</b><b>以及</b><b style="color:red">驗證信</b></h4><br>
