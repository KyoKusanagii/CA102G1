	...
	%>
		...
		<div class="panel panel-default col-md-10 col-md-offset-1">
			...
			<table class="table">
			 ...
			 <tr>
			    <td >
			    <img src="data:image/*;base64,${ItempicService.getThumbnail(item_no).encoded}" class="img-responsive" style="width:50px; height:50px">
			    </td>
			    <td>${ItemService.getOneItem(item_no).item_name}</td>
			    <td class="text-center">${MemService.findByPK(ItemService.getOneItem(item_no).item_owner).mem_name}</td>
			    <td class="text-center"><%= order.getPrice() %></td>
			    <td class="text-center"><%= order.getQuantity() %></td>
			    <td class="text-center"><%= order.getQuantity() * order.getPrice() %></td>
			 </tr>
		...
		<div class="panel panel-default col-md-10 col-md-offset-1">
			...
			<form method="post" id="myForm" name="myForm" class="form-horizontal form-inline"  action="<%=request.getContextPath()%>/ShoppingCartServlet">
			...
			<div class="panel-body col-md-offset-3">
				...
				<div class="form-group col-md-12">
					...
					<div class="col-md-10">
                        ...
                        <input type="text" class="form-control" name="add" style="width: 270px;" placeholder="街/路、樓層" value="${add}">
				...
				<div class="form-group col-md-12">
					 ...
					 <div class="col-sm-10">
						  <label class="radio-inline"> <input type="radio" name="mall_order_trans" id="inlineRadio1" value="信用卡" onclick="$('#creditCard').show();$('#transfer').hide()" checked>信用卡 / VISA金融卡</label> 
						  <label class="radio-inline"> <input type="radio" name="mall_order_trans" id="inlineRadio2" value="銀行轉帳" onclick="$('#creditCard').hide();$('#transfer').show()">銀行轉帳</label> 
						  <label class="radio-inline"> <input type="radio" name="mall_order_trans" id="inlineRadio3" value="貨到付款" onclick="$('#creditCard').hide();$('#transfer').hide()">貨到付款</label>
					</div>
					<p style="color:red; font-family:微軟正黑體;">${errorMsgs.mall_order_trans}</p>
				</div>
				...
				<div id="creditCard" >
					...
					<div class="form-group col-md-12">
						...
						<div class="col-sm-10">
							<input type="text" name="cardowner" class="form-control" placeholder="請輸入姓名" style="width:200px" value="${cardowner}">
					...
					<div class="form-group col-md-12">
						...
						<div class="col-md-10">
							 <input type="text" class="form-control" style="width: 60px" maxlength="4" name="cdno1" size="5" onkeyup="cdno(1);" value="${cdno1}">
	                         ─ 
	                         <input type="text" class="form-control" style="width: 60px" maxlength="4" name="cdno2" size="5" onkeyup="cdno(2);" value="${cdno2}">
	                         ─ 
	                         <input type="text" class="form-control" style="width: 60px" maxlength="4" name="cdno3" size="5" onkeyup="cdno(3);" value="${cdno3}">	
	                         ─ 
	                         <input type="text" class="form-control" style="width: 60px" maxlength="4" name="cdno4" size="5" value="${cdno4}">
					...
					<div class="form-group col-md-12">
						...
						<div class="col-sm-10"> 
						     <input type="text" name="expire_safe" class="form-control text-center" placeholder="安全碼" maxlength="3" style="width:70px" value="${expire_safe}">
				...
				<div class="form-group col-md-12">
					...
					<div class="col-sm-10"> 
					     <textarea name="mall_order_remark" class="form-control" cols="30" rows="5" style="resize:none;">${mall_order_remark}</textarea>
					</div>
				</div>
				
				
					<div class="col-md-offset-2 col-md-10" style="margin-top:30px">
				        <input type="submit" class="order btn btn-success" value="送出訂單" >
...
function getWrongData(){
	...
	$("select[name='expire_month']").val("${expire_month}");	//信用卡到期月份
	$("select[name='expire_year']").val("${expire_year}"); //信用卡到期年份
}
...
function getMemberData(){ //導入會員資料
	...
	$("input[name='phone']").val("${memVO.mem_mobile}")//電話
