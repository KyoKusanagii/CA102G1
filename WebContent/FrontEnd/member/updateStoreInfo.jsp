				                ...
				                <div class="col-12 col-md-12">
				                  <div class="col-md-12" align="center">
									  ...
									  <div style="margin-top:20px">
									  	<input type="file" name="mem_martcover" accept="image/*">
									  	<p style="color:red; font-family:微軟正黑體;">${errorMsgs.photo}</p>
									  </div>
	                      		  ...
	                      		  <div class="col-md-6 col-md-offset-3 " >
		                              <div class="form-group">
									    <label >賣場名稱</label>
									    <input type="text" name="mem_martname" class="form-control" value="${memVO.mem_martname}">
									    <p style="color:red; font-family:微軟正黑體;">${errorMsgs.martname}</p>
									  </div>
									  <div class="form-group">
									  	<label >賣場簡介</label>
									  	<textarea class="form-control" rows="5" name="mem_martinfo" style="resize: none;">${memVO.mem_martinfo}</textarea>
									  	 <p style="color:red; font-family:微軟正黑體;">${errorMsgs.martinfo}</p>
									  </div>
									  <div class="form-group">
									  	<label >Facebook紛絲團網址</label>
									  	<input class="form-control" name="mem_activecode" value="${memVO.mem_activecode}">
									  	 <p style="color:red; font-family:微軟正黑體;">${errorMsgs.activecode}</p>
									  </div>
				                    ...
				                    <div align="center" class="col-md-12">
				                      ...
				                      <a href="<%=request.getContextPath()%>/FrontEnd/member/storeInfo.jsp" class="btn btn-default">取消</a>
