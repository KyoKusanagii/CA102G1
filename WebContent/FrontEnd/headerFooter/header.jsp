...
<div class="header-two">
	...
	<div class="container">
		<div class="header-logo">
			<h1>
				<a href="<%=request.getContextPath()%>/FrontEnd/index.jsp"><span>Insta</span>Buy <i style="font-family: 微軟正黑體; font-size: 14px">in直拍</i></a>
			</h1>
		</div>
		...
		<div class="header-cart">
			<div class="my-account">
				<a href="<%=request.getContextPath()%>/FrontEnd/contact.jsp" style="font-family: 微軟正黑體;"><i class="fa fa-map-marker" aria-hidden="true"></i> 關於我們</a>
			</div>
			<div class="cart">
