	...
	<div class="container" style="margin-top: 5%; font-family:微軟正黑體; font-weight:bold">
		...
		<form method="post" action="article.do">
			<div class="form-group">
			    ...
			    <textarea name="arti_topic" class="form-control rounded-0" rows="3" style="resize:none; box-shadow: 1px 1px 8px black;">${articleVO.arti_topic}</textarea>
			</div>		
			<div class="form-group">
			    ...
			    <textarea name="arti_content" class="form-control " rows="16">${articleVO.arti_content}</textarea>
				</div>
			</div>
			...
			<input type="button" class="btn btn_info" value="取消" onclick="location.href = 'article.jsp?arti_no=${articleVO.arti_no}'">
			</div>
